...
`);return t?t.originalMessage=t.message:t=l,t.message=E,t.shortMessage=f,t.command=o,t.exitCode=s,t.signal=a,t.stdout=r,t.stderr=e,"bufferedData"in t&&delete t.bufferedData,t}function He({stdout:r,stderr:e,error:t,exitCode:a,signal:s,timedOut:o,command:n,options:i,parentError:l}){if(t||a!==0||s!==null)throw ze({error:t,exitCode:a,signal:s,stdout:r,stderr:e,command:n,timedOut:o,options:i,parentError:l});return r}async function w(r,e,t){if(process.platform!=="darwin")throw new Error("AppleScript is only supported on macOS");let{humanReadableOutput:a,language:s,timeout:o,...n}=Array.isArray(e)?t||{}:e||{},i=a!==!1?[]:["-ss"];s==="JavaScript"&&i.push("-l","JavaScript"),Array.isArray(e)&&i.push("-",...e);let l=ue.default.spawn("osascript",i,{...n,env:{PATH:"/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"}}),u=Le(l,{timeout:o??1e4});l.stdin.end(r);let[{error:b,exitCode:f,signal:E,timedOut:H},v,F]=await Me(l,{encoding:"utf8"},u),Te=le({stripFinalNewline:!0},v),Re=le({stripFinalNewline:!0},F);return He({stdout:Te,stderr:Re,error:b,exitCode:f,signal:E,timedOut:H,command:"osascript",options:t,parentError:new Error})}var D=require("child_process"),m=require("@raycast/api");var he=require("fs");async function Be(){let r="";try{r=(0,D.execSync)(`/bin/zsh -lc 'realpath "$(which brew)"'`).toString().trim()}catch(e){console.error(e)}if(r==="")return await(0,m.showToast)({title:"Homebrew is required to install the AVIF encoder.",message:"Please install Homebrew and try again. Visit https://brew.sh for more information. Once Homebrew is installed, run the command `brew install libavif` to install the AVIF encoder manually (Otherwise, this command will be run automatically).",style:m.Toast.Style.Failure}),!1;if(await(0,m.confirmAlert)({title:"Install AVIF Encoder",message:"The libavif Homebrew formula is required to convert images to/from AVIF format. Would you like to install it now?",primaryAction:{title:"Install"}})){let e=await(0,m.showToast)({title:"Installing AVIF Encoder...",style:m.Toast.Style.Animated});try{if((0,D.execSync)(`/bin/zsh -ilc '${r} install --quiet libavif || true'`),!Ge())throw new Error("The avifenc binary has not been added to the user's $PATH");return e.title="AVIF Encoder installed successfully!",e.style=m.Toast.Style.Success,!0}catch(t){console.error(t),g("Failed to install AVIF Encoder.",t,e,"If you previously attempted to install libavif or avifenc, please run `brew doctor` followed by `brew cleanup` and try again.")}}return await(0,m.showToast)({title:"AVIF Encoder not installed.",style:m.Toast.Style.Failure}),!1}async function Ge(){let t=!1,a=0;for(;!t&&a<7;){let s=(0,D.execSync)("/bin/zsh -lc 'command -v avifenc'").toString().trim();if((0,he.existsSync)(s)){t=!0;break}await new Promise(o=>setTimeout(o,1e3)),a++}return t}async function Q(){let r=await m.LocalStorage.getItem("avifEncoderPath"),e=await m.LocalStorage.getItem("avifDecoderPath");if(!r||!e)try{r=(0,D.execSync)(`/bin/zsh -lc 'realpath "$(which avifenc)"'`).toString().trim(),e=(0,D.execSync)(`/bin/zsh -lc 'realpath "$(which avifdec)"'`).toString().trim()}catch(t){if(await Be())try{return await Q()}catch(a){console.error(a),g("AVIF Encoder not found.",a,void 0,"Please install the libavif Homebrew formula manually and try again.")}else g("AVIF Encoder not found.",t,void 0,"Please install the libavif Homebrew formula and try again.")}return{encoderPath:r,decoderPath:e}}var me=async()=>w(`use framework "AppKit"
      ...
      end if`)};var A=$(require("path"));var M=require("child_process");function I(r,e){let t=e?.command,a=e?.language,s=[...e?.leadingArgs?.map(f=>f.toString())||[]],o=e?.trailingArgs||[];!t&&(a===void 0||a==="AppleScript"||a==="JXA")&&(t="/usr/bin/osascript",s.push("-l",a==="JXA"?"JavaScript":"AppleScript",...r.startsWith("/")?[]:["-e"],r,...o.map(f=>f.toString())));let n=process.env;if(e?.command&&(n.PATH=`${n.PATH}:${(0,M.execSync)(`$(/bin/bash -lc 'echo $SHELL') -lc 'echo "$PATH"'`).toString()}`,t=e.command,s.push(r,...o.map(f=>f.toString()))),!t)throw new Error("No command specified.");let i="",l=f=>{console.log(f)},u=(0,M.spawn)(t,s,{env:n});return e?.logDebugMessages&&console.log(`Running shell command "${t} ${s.join(" ")}"`),u.stdout?.on("data",f=>{i+=f.toString(),e?.logIntermediateOutput&&console.log(`Data from script: ${i}`)}),u.stderr?.on("data",f=>{e?.stderrCallback&&e.stderrCallback(f.toString()),e?.logErrors&&console.error(f.toString())}),u.stdin.on("error",f=>{e?.logErrors&&console.error(`Error writing to stdin: ${f}`)}),l=async f=>{f?.length>0&&(u.stdin.cork(),u.stdin.write(`${f}\r
`),process.nextTick(()=>u.stdin.uncork()),e?.logSentMessages&&console.log(`Sent message: ${f}`))},{data:(async()=>new Promise((f,E)=>{let H=e?.timeout?setTimeout(()=>{try{u.kill()}catch(v){e?.logErrors&&console.error(`Error killing process: ${v}`)}return e?.logErrors&&console.error("Script timed out"),u.stdin.end(),u.kill(),E("Script timed out")},e?.timeout):void 0;u.on("close",v=>{if(v!==0)return e?.logErrors&&console.error(`Script exited with code ${v}`),u.stdin.end(),u.kill(),E(`Script exited with code ${v}`);clearTimeout(H);let F;try{F=JSON.parse(i)}catch{F=i.trim()}return e?.logFinalOutput&&console.log(`Script output: ${F}`),f(F)})}))(),sendMessage:l}}var T=require("@raycast/api");async function be(){let r=A.default.join(T.environment.assetsPath,"scripts","finder.scpt"),e=await I(r,{language:"AppleScript",stderrCallback:t=>g("Finder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function ye(){let r=A.default.join(T.environment.assetsPath,"scripts","houdahSpot.scpt"),e=await I(r,{language:"AppleScript",stderrCallback:t=>g("HoudahSpot Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function $e(){let r=A.default.join(T.environment.assetsPath,"scripts","neofinder.scpt"),e=await I(r,{language:"AppleScript",stderrCallback:t=>g("NeoFinder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function we(){let r=A.default.join(T.environment.assetsPath,"scripts","pathfinder.scpt"),e=await I(r,{language:"JXA",stderrCallback:t=>g("Path Finder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function Se(){let r=A.default.join(T.environment.assetsPath,"scripts","qspace.scpt"),e=await I(r,{language:"JXA",stderrCallback:t=>g("QSpace Pro Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function ke(){let r=A.default.join(T.environment.assetsPath,"scripts","forklift-beta.scpt"),e=await I(r,{language:"JXA",stderrCallback:t=>g("ForkLift Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}var Y=async(r,e)=>{let t=d.default.join(y.tmpdir(),`${r}.${e}`);return{path:t,[Symbol.asyncDispose]:async()=>{p.existsSync(t)&&await p.promises.rm(t,{recursive:!0})}}};var ve=async()=>{let e=(await c.LocalStorage.getItem("itemsToRemove")??"").toString().split(", ");for(let t of e)p.existsSync(t)&&await p.promises.rm(t,{recursive:!0});await c.LocalStorage.removeItem("itemsToRemove")},Pe=async()=>{let r=[],t=(0,c.getPreferenceValues)().inputMethod,a=!1;if(t=="Clipboard")try{let n=(await me()).split(", ").reduce((i,l,u)=>(u==0||l.startsWith("/")?i.push(l):i[i.length-1]=`${i.at(-1)??""}${l}`,i),[]);if(await c.LocalStorage.setItem("itemsToRemove",n.join(", ")),n.filter(i=>i.trim().length>0).length>0)return n}catch(n){console.error(`Couldn't get images from clipboard: ${n}`),a=!0}let s=t;try{s=(await(0,c.getFrontmostApplication)()).name}catch(n){console.error(`Couldn't get frontmost application: ${n}`)}try{(t=="Path Finder"||s=="Path Finder")&&(r=await we())}catch(n){console.error(`Couldn't get images from Path Finder: ${n}`),a=!0}try{(t=="NeoFinder"||s=="NeoFinder")&&(r=await $e())}catch(n){console.error(`Couldn't get images from NeoFinder: ${n}`),a=!0}try{(t=="HoudahSpot"||s=="HoudahSpot")&&(r=await ye())}catch(n){console.error(`Couldn't get images from HoudahSpot: ${n}`),a=!0}try{(t=="QSpace"||s=="QSpace Pro"||s=="QSpace")&&(r=await Se())}catch(n){console.error(`Couldn't get images from ${s}: ${n}`),a=!0}try{(t=="ForkLift"||s=="ForkLift")&&(r=await ke())}catch(n){console.error(`Couldn't get images from ForkLift: ${n}`),a=!0}if(r.length>0)return r.filter((n,i)=>r.indexOf(n)===i);let o=await be();return s=="Finder"||t=="Finder"||a?r=o:o.forEach(n=>{n.split("/").at(-2)=="Desktop"&&!r.includes(n)&&r.push(n)}),r.filter((n,i)=>r.indexOf(n)===i)},ee=async r=>{let e="Finder";try{e=(await(0,c.getFrontmostApplication)()).name}catch(a){console.error(`Couldn't get frontmost application: : ${a}`)}let t=(0,c.getPreferenceValues)();t.imageResultHandling=="copyToClipboard"?(await ge(r),xe(r)):t.imageResultHandling=="openInPreview"?(await Xe(r),xe(r)):t.inputMethod=="NeoFinder"||e=="NeoFinder"?await(0,c.showInFinder)(r[0]):(t.inputMethod=="HoudahSpot"||e=="HoudahSpot")&&await(0,c.showInFinder)(r[0])},Ke=async()=>(y.cpus()[0].model.includes("Apple")?"arm":"x86")=="arm"?((0,S.execSync)(`chmod +x ${c.environment.assetsPath}/webp/arm/dwebp`),(0,S.execSync)(`chmod +x ${c.environment.assetsPath}/webp/arm/cwebp`),p.existsSync(`${c.environment.assetsPath}/webp/x86/dwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/x86/dwebp`),p.existsSync(`${c.environment.assetsPath}/webp/x86/cwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/x86/cwebp`),[`${c.environment.assetsPath}/webp/arm/dwebp`,`${c.environment.assetsPath}/webp/arm/cwebp`]):((0,S.execSync)(`chmod +x ${c.environment.assetsPath}/webp/x86/dwebp`),(0,S.execSync)(`chmod +x ${c.environment.assetsPath}/webp/x86/cwebp`),p.existsSync(`${c.environment.assetsPath}/webp/arm/dwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/arm/dwebp`),p.existsSync(`${c.environment.assetsPath}/webp/arm/cwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/arm/cwebp`),[`${c.environment.assetsPath}/webp/x86/dwebp`,`${c.environment.assetsPath}/webp/x86/cwebp`]),j=async(r,e)=>{var i=[];try{let t=(0,c.getPreferenceValues)();let a=N(i,await Y("tmp","png"),!0);let s=(await U([e]))[0];let[o,n]=await Ke();(0,S.execSync)(`${o} "${e}" -o "${a.path}" && ${r} "${a.path}" && ${n} ${t.useLosslessConversion?"-lossless":""} "${a.path}" -o "${s}"`);return s}catch(l){var u=l,b=!0}finally{var f=L(i,u,b);f&&await f}},V=async(r,e)=>{var i=[];try{let t=(0,c.getPreferenceValues)();let a=N(i,await Y("tmp","png"),!0);let s=(await U([e]))[0];let{encoderPath:o,decoderPath:n}=await Q();(0,S.execSync)(`${n} "${e}" "${a.path}" && ${r} "${a.path}" && ${o} ${t.useLosslessConversion?"-s 0 --min 0 --max 0 --minalpha 0 --maxalpha 0 --qcolor 100 --qalpha 100":""}  "${a.path}" "${s}"`);return s}catch(l){var u=l,b=!0}finally{var f=L(i,u,b);f&&await f}},z=async(r,e)=>{var s=[];try{let t=N(s,await Y("tmp","bmp"),!0);let a=(await U([e]))[0];await Je("BMP",e,t.path);(0,S.execSync)(`chmod +x ${c.environment.assetsPath}/potrace/potrace`);(0,S.execSync)(`${r} "${t.path}" && ${c.environment.assetsPath}/potrace/potrace -s --tight -o "${a}" "${t.path}"`);return a}catch(o){var n=o,i=!0}finally{var l=L(s,n,i);l&&await l}},Je=async(r,e,t)=>w(`use framework "Foundation"
  use scripting additions
