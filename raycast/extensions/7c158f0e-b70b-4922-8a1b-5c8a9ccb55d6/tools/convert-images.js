...
`);return t?t.originalMessage=t.message:t=f,t.message=F,t.shortMessage=u,t.command=i,t.exitCode=s,t.signal=a,t.stdout=r,t.stderr=e,"bufferedData"in t&&delete t.bufferedData,t}function gt({stdout:r,stderr:e,error:t,exitCode:a,signal:s,timedOut:i,command:n,options:c,parentError:f}){if(t||a!==0||s!==null)throw mt({error:t,exitCode:a,signal:s,stdout:r,stderr:e,command:n,timedOut:i,options:c,parentError:f});return r}async function I(r,e,t){if(process.platform!=="darwin")throw new Error("AppleScript is only supported on macOS");let{humanReadableOutput:a,language:s,timeout:i,...n}=Array.isArray(e)?t||{}:e||{},c=a!==!1?[]:["-ss"];s==="JavaScript"&&c.push("-l","JavaScript"),Array.isArray(e)&&c.push("-",...e);let f=Pe.default.spawn("osascript",c,{...n,env:{PATH:"/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"}}),l=ut(f,{timeout:i??1e4});f.stdin.end(r);let[{error:E,exitCode:u,signal:F,timedOut:H},R,T]=await dt(f,{encoding:"utf8"},l),K=xe({stripFinalNewline:!0},R),X=xe({stripFinalNewline:!0},T);return gt({stdout:K,stderr:X,error:E,exitCode:u,signal:F,timedOut:H,command:"osascript",options:t,parentError:new Error})}var Ee=async()=>I(`use framework "AppKit"
